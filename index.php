                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-12 d-flex flex-column justify-content-center align-items-center">
                              <div class="hero-text">l
                                   ...
                                   <strong class="d-block py-3 pl-5 text-white" data-aos="fade-up" data-aos-delay="200"><i class="fa fa-phone mr-2"></i>+254 729 734 442/ +254 728 430 681</strong>
                              </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-12">
                          <div class="hero-image" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <!-- <img src="images/ccvplogo3.png" class="img-fluid" alt="working girl"> -->
                          </div>
                        </div>
                    ...
                    <div class="col-lg-7 mx-auto col-md-10 col-12">
                         ...
                         <div class="owl-carousel owl-theme" id="project-slide">
                              <div class="item project-wrapper" data-aos="fade-up" data-aos-delay="100">
                                   <img src="images/abdi.png" class="img-fluid" alt="office"></div></div>
               ...
               <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        ...
                        <h2 class="mb-5 text-center" data-aos="fade-up">
                            ...
                            <strong>featured achievements.</strong><a href="project-detail.html">project</a> 
                        </h2>
               ...
               <div class="row">
                    ...
                    <div class="col-lg-6 col-md-5 col-12">
                        <div class="contact-image" data-aos="fade-up">
                          ...
                          <img src="images/fatum.png" class="img-fluid" alt="website">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-7 col-12">
                      ...
                      <h2 class="mb-4" data-aos="fade-up" data-aos-delay="300">“I just wanted to share a quick note and let you know that you guys do a really good job. I’m glad I decided to work with you. 
                         
                         Thanks, guys!”</h2>

                      <p data-aos="fade-up" data-aos-delay="400">
                        <strong>Fatum Zahra</strong>

                        <span class="mx-1">/</span>

                        <small>Member of CBO</small>
                        <span class="mx-1">-</span>
                        <em>10/02/2019</em>
                      </p>
                    </div>
