...
<body>
    ...
    <nav class="navbar navbar-expand-lg position-relative">
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-lg-9 mx-auto col-md-10 col-12 mt-lg-5 text-center" data-aos="fade-up">
                      ...
                      <h1>CCVP representative sensitizing on performance and how to improve on their academics</h1>
                    </div>
     ...
     <div class="full-image text-center" data-aos="zoom-in">
       <img src="images/abdi.png" class="img-fluid" alt="interview process">
     </div>
     ...
     <section class="project-detail section-padding">
          <div class="container">
               <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-12 mb-5">
                    ...
                    <div class="col-lg-5 col-md-6 mr-lg-auto mt-lg-5 col-12" data-aos="fade-up" data-aos-delay="200">
                      ...
                      <p class="mt-3 mb-4">The main aim of (CCVP) is to restore hope for many vulnerable people by reducing human suffering through education, Livelihood, Health, Education, protection, and WASH infrastructure.</p>
                      ...
                      <ul class="list-detail">
                        ...
                        <li><span>To contribute to the realization of peace and health for sustainable human development in poor and marginalized areas. </span></li>
                      </ul>
                    </div>
               </div>
            ...
            <a style="position:absolute;top:20px;right:1rem;opacity:0.8;" href="https://clipchamp.com/watch/E0hrzwnGkRR?utm_source=embed&utm_medium=embed&utm_campaign=watch">
                <img style="height:22px;" src="https://clipchamp.com/e.svg" alt="Made with Clipchamp" />
            </a>
            <iframe allowfullscreen style="border:none" src="https://clipchamp.com/watch/E0hrzwnGkRR/embed" width="640" height="360"></iframe>
        </div>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/6ieGYRpe1bg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              ...
              <div class="col-lg-9 mx-auto col-12" data-aos="fade-up">
                <div class="client-info mt-lg-5 py-lg-5">
                    <h2>CCVP has been working actively for past 2 years in Golbo Ward, Dabel Division while collaborating with County government of Marsabit to deliver its program effectively.  </h2>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5 mx-lg-auto col-md-8 col-10">
             <h1 class="text-white" data-aos="fade-up" data-aos-delay="100">Welcome to  <strong>CCVP</strong> Our Home.</h1>
          </div>
          ...
          <div class="col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-delay="200">
            ...
            <p class="mb-1">
             ...
             Phone: +254 0729 734 442/0728430681
            </p>
